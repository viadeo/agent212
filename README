...
![Agent 212](http://en.wikipedia.org/wiki/Agent_212)
...
It does not try to detect browsers but if you write some code around it you can use it for this purpose. If this is what you want to do you might want to take a look at https://github.com/kevinelliott/agent_orange .
